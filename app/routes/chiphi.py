...
def chiphi_page():
    ...
    selected_honda_type_id = request.form.get('selected_honda_type_id') or request.args.get('selected_honda_type_id') or session.get('chiphi_selected_honda_type_id')
    selected_honda_type = HondaType.query.get(selected_honda_type_id)
    alternatives = []
    if selected_honda_type_id:
        session['chiphi_selected_honda_type_id'] = selected_honda_type_id
    ...
    if request.method == "POST" and criteria and selected_honda_type:
        ...
        comparison_matrix_data = generate_alternative_comparison_matrix_data(alternatives, criteria.id, selected_honda_type_id, load_suggestions, session.get('chiphi_comparison_values'))
    else:
